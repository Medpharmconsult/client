        ...
        >
          <Row classname="lg:flex-row-reverse ">
            <Row.Column breakPoints="lg:w-7/12 xl:w-8/12">
              <div className="bg-white rounded-5 border-1 border-grey-300 ">
                <div>
                  <div className=" flex-wrap xs:flex-nowrap flex items-center gap-4 px-4 py-6">
                    <div>
                      <ProfileImg
                    ...
                    <div className="flex flex-col gap-y-2">
                      <h3 className="font-medium tracking-normal capitalize lg:text-[28px]/[36px] text-[24px]/[32px]">{`${professional.lastName} ${professional.firstName}`}</h3>
                      <h3 className="text-grey-100 font-medium uppercase text-sm tracking-[0.1px]">
